...
const validate = async (params) => {
  ...
  if (params.scope !== 'shefaa:manage') throw new Error('النطاق المطلوب غير مسموح.')
}
...
export const POST = async (request) => {
  ...
  try {
    ...
    const code = await issueAuthorizationCode({ clientId: params.client_id, redirectUri: params.redirect_uri, codeChallenge: params.code_challenge, scope: params.scope })
